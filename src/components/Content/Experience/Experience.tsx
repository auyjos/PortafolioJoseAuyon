  ...
  return (
    <Wrapper style={{ animation: `${fadeIn} 0.5s ease-in-out` }}>
      <CompanyWrapper>
        <div className="logo">
          <img
            src="https://res.cloudinary.com/webuvg/image/upload/f_auto,q_auto,w_164,c_scale,fl_lossy,dpr_2.63/v1541691361/WEB/Nosotros/Imagen%20Institucional/Escudo%20UVG/Escudo%20UVG%20Campus%20Sur/escudo-uvg-campussur_thumb2x.jpg"
            alt="logo"
          />
        </div>
